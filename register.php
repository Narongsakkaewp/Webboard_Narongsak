                ...
                <div class="card border-primary">
                    ...
                    <div class="card-body">
                        <form action="register_save.php" method="post">
                            ...
                            <div class="row mt-3">
                                <label for="pwd2" class="col-lg-3 col-form-label">ยืนยันรหัสผ่าน:</label>
                                <div class="col-lg-9">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="form-check">
                                        <input type="radio" name="gender" value="w" class="form-check-input" required>
                                        <label class="form-check-label">หญิง</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" name="gender" value="o" class="form-check-input" required>
                                        <label class="form-check-label">อืน ๆ</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
